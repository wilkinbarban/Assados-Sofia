create function public.attach_sofia_inbound_message(
  p_message_id uuid,
  p_conversa_id uuid,
  p_cliente_id uuid,
  p_canal text
...
begin
  ...
  if p_message_id is null or p_conversa_id is null or p_cliente_id is null or p_canal not in ('telegram','whatsapp') then
  ...
  if (p_canal='telegram' and v_message.telegram_mensagem_id is null)
     or (p_canal='whatsapp' and v_message.whatsapp_mensagem_id is null) then
