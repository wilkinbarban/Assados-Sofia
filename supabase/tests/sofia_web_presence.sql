...
-- The canonical self-hosted clone can already contain the objects these imports replay, so clear
...
drop function if exists public.get_sofia_conversation_presence(uuid);
