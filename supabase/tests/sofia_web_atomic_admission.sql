...
insert into admissao select 'retry',* from public.enqueue_sofia_inbound_message('c2000000-0000-4000-8000-000000000001','c1000000-0000-4000-8000-000000000001','web','web-key-1','ignorado',null);
