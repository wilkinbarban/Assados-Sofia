...
values ('28282828-2828-4282-8282-282828282841','28282828-2828-4282-8282-282828282821','aberta',false)
...
values ('28282828-2828-4282-8282-282828282861','28282828-2828-4282-8282-282828282821','confirmado','pendente','retirada','pix',4200,0,4200)
on conflict do nothing;
reset role;
...
begin
  select * into canonical from public.admit_payment_proof_intake(
    ...
    '28282828-2828-4282-8282-282828282861','28282828-2828-4282-8282-282828282841',repeat('b',64)
  );
  select * into duplicate_hash from public.admit_and_enqueue_payment_proof(
    'telegram', 'lifecycle-duplicate', '28282828-2828-4282-8282-282828282821', null,
    'proofs/private/lifecycle-duplicate.pdf', 100, 'application/pdf',null,
    '28282828-2828-4282-8282-282828282841',repeat('b',64)
  );
  ...
  select count(*) into queued from public.payment_proof_outbox
    where proof_id = duplicate_hash.proof_id and event_type = 'payment_proof_duplicate';
