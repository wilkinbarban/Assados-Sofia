select to_regclass('public.payment_proof_leases') is null as apply_operator_leases \gset
\if :apply_operator_leases
...
insert into public.conversas(id,cliente_id,status,ia_ativa) values
 ('51515151-5151-4151-8151-515151515131','51515151-5151-4151-8151-515151515121','aberta',false)
on conflict do nothing;
...
select lives_ok(
 $$select * from public.admit_payment_proof_intake(
   ...
   '51515151-5151-4151-8151-515151515131',repeat('4',64)
 )$$,
...
select throws_ok(
 $$select * from public.admit_payment_proof_intake(
   ...
   100,'application/pdf','51515151-5151-4151-8151-515151515141',
   '51515151-5151-4151-8151-515151515131',repeat('5',64)
 )$$,
...
select throws_ok(
 $$select * from public.admit_payment_proof_intake(
   ...
   '51515151-5151-4151-8151-515151515131',repeat('6',64)
 )$$,
...
set role postgres;select is((select holder_actor_id from public.payment_proof_leases where proof_id=(select id from public.payment_proofs where delivery_key='order-lock-1')),(select '51515151-5151-4151-8151-515151515103'::uuid),'expiry permits a new holder');reset role;set role authenticated;
...
set role postgres;select is((select count(*)::integer from public.payment_proof_leases where proof_id=(select id from public.payment_proofs where delivery_key='order-lock-1')),0,'release removes proof lease');
set role postgres;update public.perfis set ativo=false where id='51515151-5151-4151-8151-515151515103';reset role;set role authenticated;
