...
source_unit="$source_directory/asados-slice2-credential-bootstrap.service"
source_provisioner="$source_directory/provision-slice2-staging-secret"
installed_unit=/etc/systemd/system/asados-slice2-credential-bootstrap.service
installed_provisioner=/usr/local/lib/asados/provision-slice2-staging-secret
installed_documentation=/usr/local/share/doc/asados/slice2-credential-bootstrap.md
...
install -o root -g root -m 0644 "$source_directory/slice2-credential-bootstrap.md" "$installed_documentation"
...
systemctl start asados-slice2-credential-bootstrap.service
